    ...
    <section id="contact" className="relative overflow-hidden bg-navy py-20 text-white lg:py-28">
      ...
      <div className="container-premium relative grid items-center gap-12 lg:grid-cols-[0.9fr_1fr]">
        <Reveal>
          ...
          <h2 className="mt-6 text-3xl font-black leading-tight sm:text-4xl lg:text-5xl">Ready to Schedule Your HVAC Service?</h2>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            <a href={`tel:${business.phone}`} className="flex min-w-0 items-center gap-4 rounded-2xl bg-white/10 p-5 transition hover:bg-white/15">
            ...
            <a href={`mailto:${business.email}`} className="flex min-w-0 items-center gap-4 rounded-2xl bg-white/10 p-5 transition hover:bg-white/15">
              <span className="grid h-12 w-12 place-items-center rounded-full bg-white/15">
